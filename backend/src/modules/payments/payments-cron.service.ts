...
export class PaymentsCronService {
  ...
  private async reconcileTransaction(transaction: any) {
    ...
    // Add other gateways here (MoMo, VNPay) as needed
  }
  ...
  private async reconcilePayOSTransaction(transaction: any) {
    ...
    try {
      ...
      // If payment succeeded, update booking (only if not already paid)
      ...
      // If payment not found on gateway (404), mark as failed

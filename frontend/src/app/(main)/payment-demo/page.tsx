  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-8">
      <div className="mb-8 text-center">
        <h1 className="mb-4 text-3xl font-bold">Demo Thanh Toán QR</h1>
        <p className="text-gray-600">Tạo mã QR thanh toán cho các ngân hàng Việt Nam</p>
      </div>
          ...
          <Card key={index} className="transition-shadow hover:shadow-lg">
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <Button onClick={() => handleOpenModal(scenario)} className="w-full">
                  Tạo QR
                </Button>
              </div>
            </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <h4 className="mb-2 font-semibold">🏦 Ngân hàng hỗ trợ</h4>
            ...
            <div>
              <h4 className="mb-2 font-semibold">📱 Tính năng</h4>
              <ul className="space-y-1 text-sm text-gray-600">

...
export default function ShowQRCodesPage({
  ...
  const registrationLink = qrCode
    ? `${typeof window !== 'undefined' ? window.location.origin : ''}/register-performance?code=${qrCode.code}`
    : '';
      ...
      <Card>
        ...
        <CardContent className="flex flex-col items-center space-y-6">
          {!qrCode ? (
            ...
            <>
              <div className="rounded-xl border-2 border-dashed border-neutral-200 bg-white p-4 shadow-sm print:border-none">
                <QRCodeSVG
                  id="qr-code-svg"
              ...
              <div className="mt-6 grid w-full max-w-lg grid-cols-2 gap-4 border-t pt-6 print:hidden">
                <div className="rounded-lg bg-neutral-50 p-4 text-center">
                  <p className="text-xs font-semibold uppercase text-neutral-500">Lượt quét</p>

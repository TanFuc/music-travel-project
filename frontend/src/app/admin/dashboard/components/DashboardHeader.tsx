    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-600 text-base mt-2">Tong quan he thong quan ly</p>
        </div>
        <div className="flex items-center gap-2 text-sm font-medium text-slate-600 bg-white/70 backdrop-blur-md px-4 py-2 rounded-full shadow-md border border-white/50">
          ...
          <span>Cap nhat: {new Date().toLocaleTimeString('vi-VN', { hour: '2-digit', minute: '2-digit' })}</span>
        </div>
      </div>
    </div>
  );

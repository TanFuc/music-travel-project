      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-neutral-600">
            Quản lý hình ảnh và thông tin sân khấu hiển thị ở trang chủ
          </p>
        </div>
              ...
              {stages.map((stage) => (
                ...
                >
                  <div className="flex flex-col items-start gap-4 md:flex-row">
                    <div className="relative h-24 w-40 shrink-0 overflow-hidden rounded-md border bg-neutral-100">
                      <Image
                        src={stage.imageUrl}
                        alt={stage.title}
                        fill
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      {stage.description && (
                        <p className="line-clamp-2 text-sm text-neutral-600">{stage.description}</p>
                      )}

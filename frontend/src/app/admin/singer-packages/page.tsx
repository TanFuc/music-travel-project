...
import {
  singerPackageService,
  type SingerPackage,
  type CreateSingerPackageDto,
  type UpdateSingerPackageDto,
  type SingerPackageFilterDto,
} from '@/services/singer-packages.service';
const LIMIT_OPTIONS = [
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-gray-600">Quản lý các gói đăng ký cho chương trình ca sĩ</p>
        </div>
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="py-8 text-center text-red-600">Có lỗi xảy ra khi tải dữ liệu</div>
          ) : !packagesData?.data.length ? (
            <div className="py-8 text-center text-gray-500">Không có gói đăng ký nào</div>
          ) : (
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-500">
                          ...
                          {pkg._count && <span>Đã đăng ký: {pkg._count.registrations} người</span>}
                        </div>
                      </div>
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                Bạn có chắc chắn muốn xóa gói "{pkg.name}"? Hành động này không thể
                                hoàn tác.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
      ...
      <PackageDialog
        ...
        onSubmit={(data) =>
          editingPackage && updateMutation.mutate({ id: editingPackage.id, data })
        }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            {initialData
              ? 'Chỉnh sửa thông tin gói đăng ký'
              : 'Tạo gói đăng ký mới cho chương trình ca sĩ'}
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-neutral-500">Để trống nếu không giảm giá</p>
            </div>
          </div>

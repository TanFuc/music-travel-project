...
import {
  ...
  type SingerRegistrationFilter,
} from '@/services/singer.service';
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              {registrationsData.data.map((registration) => (
                <div key={registration.id} className="rounded-lg border p-4 hover:bg-gray-50">
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              Bạn có chắc chắn muốn xóa đăng ký của {registration.fullName}? Hành
          ...
          {registrationsData && registrationsData.pagination.totalPages > 1 && (
            <div className="mt-6 flex items-center justify-between">
              <p className="text-sm text-gray-600">
                Hiển thị {((filters.page || 1) - 1) * (filters.limit || 10) + 1} -{' '}
                {Math.min(
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p>
                    {getPackageLabel(selectedRegistration.package as any)} -{' '}
                    {getPackagePrice(selectedRegistration.package as any)}
                  </p>
                </div>
                <div>
              ...
              {selectedRegistration.introduction && (
                <div>
                  ...
                  <p className="mt-1 rounded-md bg-gray-50 p-3">
                    {selectedRegistration.introduction}
                  </p>
                </div>
              )}
              ...
              {selectedRegistration.adminNotes && (
                <div>
                  ...
                  <p className="mt-1 rounded-md bg-yellow-50 p-3">
                    {selectedRegistration.adminNotes}
                  </p>
                </div>
              )}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setStatusUpdate((prev) => ({ ...prev, adminNotes: e.target.value }))
                  }

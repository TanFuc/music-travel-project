...
export const ShowCard = React.memo(function ShowCard({
  ...
  return (
    <div className="group glass-card card-hover overflow-hidden border-none h-full flex flex-col relative">
      {/* Wishlist Button - Separated to avoid nested links and allow stopPropagation */}
      <button

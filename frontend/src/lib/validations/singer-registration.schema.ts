...
export const singerRegistrationSchema = z.object({
  fullName: z
    .string()
  ...
  age: z
    .number()
    .min(16, 'Tuổi phải từ 16 trở lên')
    .max(80, 'Tuổi không được vượt quá 80'),
  ...
  packageTemplateId: z
    .string()
    .uuid('ID gói đăng ký không hợp lệ')
    .optional(),
  ...
  // voiceSampleUrl: z
  //   .string()
  //   .url('URL file âm thanh không hợp lệ')
  //   .optional(),
